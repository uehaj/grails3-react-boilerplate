    ...
    return (
      <ModalDialog title={this.state.book ? this.state.book.title : 'loading..'}
        ...
        <form className="form-horizontal">
          <FormControl.Static label="Title:" labelClassName="key col-xs-2" wrapperClassName="col-xs-10" value={this.state.book ? this.state.book.title : 'loading..'} />
          <FormControl.Static label="Price:" labelClassName="key col-xs-2" wrapperClassName="col-xs-10" value={this.state.book ? this.state.book.price : 'loading..'} />
        </form>
      </ModalDialog>
    );
  }
